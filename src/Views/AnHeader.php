...
<body>
    <header>
        ...
        <nav id="nav">
            <a href="/sign-in" title="Sign in"><i class="fas fa-sign-in-alt fa-2x"></i></a>
            <a href="/sign-up" title="Sign-up"><i class="fas fa-plus fa-2x"></i></a>
            <a href="/" title="Home"><i class="fa-solid fa-house fa-2x"></i></a>
        ...
        <nav id="nav-mobile">
            ...
            <div id="nav-mobile_item">
                <ul>
                    <li><a href="http://127.0.0.6/sign-in" title="Sign In"><i class="fas fa-sign-in-alt"></i></a></li>
                    <li><a href="http://127.0.0.6/sign-up"><i class="far fa-sign-in fa-2x"></i></a></li>
                    <li><a href="http://127.0.0.6/" title="Home"><i class="fas fa-plus fa-2x"></i></a></li>
                    <li><a href="">&nbsp;</a></li>
                </ul>
            </div>
        </nav>
